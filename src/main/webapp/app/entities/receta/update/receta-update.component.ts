...
export class RecetaUpdateComponent implements OnInit {
  ...
  protected updateForm(receta: IReceta): void {
    this.editForm.patchValue({
      ...
      fechaEmision: receta.fechaEmision ? receta.fechaEmision.format(DATE_TIME_FORMAT) : null,
      fechaVencimiento: receta.fechaVencimiento ? receta.fechaVencimiento.format(DATE_TIME_FORMAT) : null,
